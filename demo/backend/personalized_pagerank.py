...
class Recommender(object):
	...
	def recommend(self, input, limit):
		...
		rank = self.G.personalized_pagerank(vertices = np.array([candidate["ID"] for candidate in candidates]), weights='weight', directed = False, damping = 0.9, reset_vertices = self.startID)
		candidateList = []
